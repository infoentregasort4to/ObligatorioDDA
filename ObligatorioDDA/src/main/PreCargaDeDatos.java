...
public class PreCargaDeDatos
{
    public void Cargar()
    {
        ...
        Cliente c2 = new ClienteConCosto(tc2,"1247","Tincho","mail2@mail.com");
        Cliente c3 = new ClienteConCosto(tc3,"1257"," Seba2","mail3@mail.com");
        Cliente c4 = new ClienteConCosto(tc2,"1267"," John","mail4@mail.com");        
