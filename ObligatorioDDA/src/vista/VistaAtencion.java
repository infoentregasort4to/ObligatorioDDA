...
public class VistaAtencion extends javax.swing.JDialog implements Observador {
    ...
    public VistaAtencion(java.awt.Frame parent, boolean modal, Puesto p)
    {
        super(parent, modal);
        initComponents();
        ff.agregar(this);
        this.p=p;
        this.atencion= ff.obtenerAtencionPuesto(p);
        if(atencion!=null){
            mostrarAtencion();
        }
    ...
    {          
       nombreAtencion.setText( "Numero: " + atencion.getNumero() + " --- Cliente: " +atencion.getCliente().toString());
    }
